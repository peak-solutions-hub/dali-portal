...
import { CheckCircle, FileIcon, Loader2, Upload, X } from "lucide-react";
import {
	createContext,
...
interface DropzoneProps extends UseSupabaseUploadReturn {
	className?: string;
}
					...
					>
						...
						<div className="shrink grow flex flex-col items-start truncate">
							...
							{file.errors.length > 0 ? (
								...
								<p className="text-xs text-primary">Successfully uploaded</p>
							) : (
								<p className="text-xs text-muted-foreground">
