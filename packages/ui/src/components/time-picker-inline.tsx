...
interface TimePickerInlineProps {
	...
	value: string;
	/** Callback with "HH:mm" 24-hour string */
	onChange: (value: string) => void;
	className?: string;
}

/** Scrollable column with native mouse wheel support */
...
/**
 * Inline time picker with hour/minute/AM-PM scrollable columns.
 * Unlike TimePicker, this does NOT wrap in a Popover —
 * intended for embedding inside another container.
 */
...
export { TimePickerInline };
export type { TimePickerInlineProps };
