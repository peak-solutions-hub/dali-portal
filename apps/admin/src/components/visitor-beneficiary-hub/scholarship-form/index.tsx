				...
				<div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
					...
					<div>
						...
						>
							<SelectTrigger
								className={
									hasFieldError("scholarshipSex") ? "border-red-500" : undefined
								}
							>
			...
			{step === 2 && (
				<div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
					...
					<div>
						...
						<Input
							className={hasFieldError("heiUii") ? "border-red-500" : undefined}
			...
			{step === 4 && (
				<div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
					...
					<div>
						...
						<Input
							className={
								hasFieldError("fatherGivenName") ? "border-red-500" : undefined
							}
					...
					<div>
						...
						<Input
							className={
								hasFieldError("fatherMiddleName") ? "border-red-500" : undefined
							}
					...
					<div>
						<label className="text-sm font-medium text-gray-700">
							Mother's Maiden Last Name <span className="text-red-500">*</span>
						</label>
						<Input
							className={
					...
					<div>
						<label className="text-sm font-medium text-gray-700">
							Mother's Maiden Given Name <span className="text-red-500">*</span>
						</label>
						<Input
							className={
				...
				<div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
					...
					<div>
						...
						>
							...
							<Input
								className="border-0 shadow-none focus-visible:ring-0"
								value={formState.guardianContactNo}
								onChange={(event) =>
									updateField(
										"guardianContactNo",
										event.target.value.replace(/\D/g, "").slice(0, 10),
