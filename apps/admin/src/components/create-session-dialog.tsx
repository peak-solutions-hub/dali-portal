...
import { Calendar, X } from "@repo/ui/lib/lucide-react";
				...
				<div className="flex items-center justify-between p-6 border-b">
					<div>
						...
						<p className="text-sm text-gray-600 mt-1">
							Schedule a new council session. Sessions must be held on
							Wednesdays.
						</p>
					</div>
					<button
						...
						<div className="space-y-2">
							...
							<Select value={sessionType} onValueChange={setSessionType}>
								...
								<SelectContent>
									...
									<SelectItem value="committee">Committee Hearing</SelectItem>
								</SelectContent>
							</Select>
						</div>
