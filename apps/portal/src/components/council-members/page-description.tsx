export function PageDescription() {
	return (
		<section className="relative h-100 bg-cover bg-center text-white overflow-hidden">
			<div className="absolute inset-0 bg-cover bg-center bg-[url('/legislative-building.png')]" />
			<div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(166,2,2,0.2)_0%,rgba(166,2,2,0.2)_100%),linear-gradient(180deg,rgba(0,0,0,0.7)_0%,rgba(0,0,0,0.5)_50%,rgba(0,0,0,0.7)_100%)]" />
