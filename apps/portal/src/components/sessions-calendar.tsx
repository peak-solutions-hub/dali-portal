				...
				<div className="flex gap-2">
					...
					>
						<Button
							size="sm"
							variant="outline"
							className="h-8 border-[rgba(0,0,0,0.1)] bg-white px-3 text-sm"
						>
							Today
						</Button>
					</Link>
					...
					>
						<Button
							size="sm"
							variant="outline"
							className="h-8 w-10 border-[rgba(0,0,0,0.1)] bg-white p-0"
						>
				...
				<div className="grid grid-cols-7 gap-2">
					{calendarCells.map((cell, index) => {
						...
						return (
							<div
								key={index}
								className={`flex min-h-24 flex-col rounded-lg p-2 ${borderClass} ${bgClass}`}
							>
								<p
