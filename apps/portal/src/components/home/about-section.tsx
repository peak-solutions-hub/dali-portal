		...
		<section className="bg-white py-16 border-b border-gray-200">
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				<div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
					...
					<Card className="bg-linear-to-br from-[#a60202] to-[#8a0101] text-white border-0 shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-xl relative overflow-hidden group">
					...
					{/* Regular Session Day */}
					<Card className="bg-linear-to-br from-[#FFC107] to-[#FFB300] text-gray-900 border-0 shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-xl relative overflow-hidden group">
						<div className="absolute inset-0 bg-black/0 group-hover:bg-black/10 transition-all duration-300" />
						<div className="p-6 flex items-center gap-6 relative z-10">
