...
- RM flow tests are consolidated in `apps/admin-e2e/tests/flows/rm-flow.spec.ts`.
- Pending RM scenarios are retained as `test.fixme` entries in the same master file.
