...
- AUTH-1: `AUTOMATED` (`apps/admin-e2e/tests/auth/auth-flows.spec.ts`)
- AUTH-2: `AUTOMATED` (`apps/admin-e2e/tests/auth/auth-flows.spec.ts`)
...
- AUTH-6: `AUTOMATED` (`apps/admin-e2e/tests/auth/auth-flows.spec.ts`)
- AUTH-7: `AUTOMATED` (`apps/admin-e2e/tests/auth/auth-flows.spec.ts`)
- AUTH-8: `AUTOMATED` (`apps/admin-e2e/tests/auth/auth-flows.spec.ts`)
- AUTH-9: `GAP` (confirm password mismatch not explicitly automated in E2E)
- AUTH-10: `AUTOMATED` (`apps/admin-e2e/tests/auth/auth-flows.spec.ts`)
- AUTH-11: `AUTOMATED` (`apps/admin-e2e/tests/auth/auth-flows.spec.ts`)
- AUTH-12: `AUTOMATED` (`apps/admin-e2e/tests/auth/auth-flows.spec.ts`)
- AUTH-13: `AUTOMATED` (`apps/admin-e2e/tests/auth/auth-flows.spec.ts`)
- AUTH-14: `AUTOMATED` (`apps/admin-e2e/tests/auth/auth-flows.spec.ts`)
- AUTH-15: `GAP` (live password criteria + disabled submit path not explicitly automated)
- AUTH-16: `AUTOMATED` (`apps/admin-e2e/tests/auth/auth-flows.spec.ts`)
- AUTH-17: `GAP` (deactivated recovery-link flow not explicitly automated)
- AUTH-18: `AUTOMATED` (`apps/admin-e2e/tests/auth/auth-flows.spec.ts`)
- AUTH-19: `AUTOMATED` (`apps/admin-e2e/tests/auth/auth-rate-limit.spec.ts`)
- AUTH-20: `AUTOMATED` (`apps/admin-e2e/tests/auth/auth-flows.spec.ts`)
